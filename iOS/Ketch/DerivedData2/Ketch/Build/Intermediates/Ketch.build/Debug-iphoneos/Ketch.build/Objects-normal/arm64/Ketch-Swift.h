...
- (void)handleKeyboardWillShow:(NSNotification * _Nonnull)notification;
...
SWIFT_CLASS("_TtC5Ketch19FavoritesController")
...
- (void)unfavorite;
- (void)favorite;
@property (nonatomic, readonly, strong) UIButton * _Nonnull reportButton;
...
SWIFT_CLASS("_TtC5Ketch26IndividualReviewController")
@interface IndividualReviewController : UIViewController <UIScrollViewDelegate, UICollectionViewDelegateFlowLayout, UICollectionViewDelegate, UITextFieldDelegate>
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified itemTitle;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified itemPrice;
@property (nonatomic, weak) IBOutlet UITextView * _Null_unspecified itemDesc;
@property (nonatomic, weak) IBOutlet UITextView * _Null_unspecified descField;
...
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified editButton;
...
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (void)tableView:(UITableView * _Nonnull)tableView didSelectRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
- (void)showReviewControllerWithReview:(review * _Nonnull)review;
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
- (void)checkIfUserIsLoggedIn;
- (void)viewWillAppear:(BOOL)animated;
- (void)showChatControllerForUserWithUser:(user * _Nonnull)user;
...
@property (nonatomic, copy) NSString * _Nullable forUser;
@property (nonatomic, copy) NSString * _Nullable ratingID;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
